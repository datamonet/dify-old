...
workflow_app_log_partial_fields = {
    "id": fields.String,
    "workflow_run": fields.Nested(
        workflow_run_for_log_fields, attribute="workflow_run", allow_null=True
    ),
...
workflow_app_log_pagination_fields = {
    ...
    "data": fields.List(
        fields.Nested(workflow_app_log_partial_fields), attribute="items"
    ),
}
