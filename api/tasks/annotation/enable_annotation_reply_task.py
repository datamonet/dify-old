...
def enable_annotation_reply_task(
    ...
    """
    logging.info(
        click.style("Start add app annotation to index: {}".format(app_id), fg="green")
    )
    ...
    try:
        ...
        if annotations:
            ...
            try:
                ...
                logging.info(
                    click.style(
                        "Delete annotation index error: {}".format(str(e)), fg="red"
                    )
                )
        ...
        logging.info(
            click.style(
                "App annotations added to index: {} latency: {}".format(
        ...
        enable_app_annotation_error_key = "enable_app_annotation_error_{}".format(
            str(job_id)
        )
