...
class HttpClient:
    ...
    def _process_response_data(
        ...
        *,
        ...
        try:
            if inspect.isclass(cast_type) and issubclass(
                cast_type, ModelBuilderProtocol
            ):
    ...
    def get(
        ...
        *,
        ...
        return cast(
            ResponseT,
            self.request(cast_type, opts, stream=stream, stream_cls=stream_cls),
        )
