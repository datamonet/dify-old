...
def upgrade():
    ...
    with op.batch_alter_table("api_requests", schema=None) as batch_op:
        batch_op.create_index(
            "api_request_token_idx", ["tenant_id", "api_token_id"], unique=False
        )
    ...
    with op.batch_alter_table("api_tokens", schema=None) as batch_op:
        batch_op.create_index(
            "api_token_app_id_type_idx", ["app_id", "type"], unique=False
        )
    ...
    with op.batch_alter_table("app_dataset_joins", schema=None) as batch_op:
        batch_op.create_index(
            "app_dataset_join_app_dataset_idx", ["dataset_id", "app_id"], unique=False
        )
    ...
    with op.batch_alter_table("dataset_keyword_tables", schema=None) as batch_op:
        batch_op.create_index(
            "dataset_keyword_table_dataset_id_idx", ["dataset_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "mode",
            sa.String(length=255),
            server_default=sa.text("'automatic'::character varying"),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("dataset_process_rules", schema=None) as batch_op:
        batch_op.create_index(
            "dataset_process_rule_dataset_id_idx", ["dataset_id"], unique=False
        )
    ...
    with op.batch_alter_table("dataset_queries", schema=None) as batch_op:
        batch_op.create_index(
            "dataset_query_dataset_id_idx", ["dataset_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "provider",
            sa.String(length=255),
            server_default=sa.text("'vendor'::character varying"),
            nullable=False,
        ),
        sa.Column(
            "permission",
    ...
    with op.batch_alter_table("document_segments", schema=None) as batch_op:
        batch_op.create_index(
            "document_segment_dataset_id_idx", ["dataset_id"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "document_segment_document_id_idx", ["document_id"], unique=False
        )
        batch_op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("completed_at", sa.DateTime(), nullable=True),
        sa.Column(
            "is_paused", sa.Boolean(), server_default=sa.text("false"), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_anonymous", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
    ...
    with op.batch_alter_table("end_users", schema=None) as batch_op:
        batch_op.create_index(
            "end_user_session_id_idx", ["session_id", "type"], unique=False
        )
        batch_op.create_index(
    ...
    with op.batch_alter_table("installed_apps", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "installed_app_tenant_id_idx", ["tenant_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.String(length=16),
            server_default=sa.text("'unused'::character varying"),
            nullable=False,
        ),
    ...
    with op.batch_alter_table("invitation_codes", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "invitation_codes_code_idx", ["code", "status"], unique=False
        )
    ...
    with op.batch_alter_table("message_agent_thoughts", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "message_agent_thought_message_id_idx", ["message_id"], unique=False
        )
    ...
    with op.batch_alter_table("message_chains", schema=None) as batch_op:
        batch_op.create_index(
            "message_chain_message_id_idx", ["message_id"], unique=False
        )
    ...
    with op.batch_alter_table("message_feedbacks", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "message_feedback_message_idx", ["message_id", "from_source"], unique=False
        )
    ...
    with op.batch_alter_table("pinned_conversations", schema=None) as batch_op:
        batch_op.create_index(
            ...
            ["app_id", "conversation_id", "created_by"],
            unique=False,
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_valid", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
    ...
    with op.batch_alter_table("recommended_apps", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "recommended_app_is_listed_idx", ["is_listed"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("account_id", postgresql.UUID(), nullable=False),
        sa.Column(
            "role", sa.String(length=16), server_default="normal", nullable=False
        ),
    ...
    with op.batch_alter_table("tenant_account_joins", schema=None) as batch_op:
        batch_op.create_index(
            "tenant_account_join_account_id_idx", ["account_id"], unique=False
        )
        batch_op.create_index(
            "tenant_account_join_tenant_id_idx", ["tenant_id"], unique=False
        )
    ...
    with op.batch_alter_table("message_annotations", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "message_annotation_conversation_idx", ["conversation_id"], unique=False
        )
        batch_op.create_index(
            "message_annotation_message_idx", ["message_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "message_tokens", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "message_unit_price", sa.Numeric(precision=10, scale=4), nullable=False
        ),
        sa.Column("answer", sa.Text(), nullable=False),
        sa.Column(
            "answer_tokens", sa.Integer(), server_default=sa.text("0"), nullable=False
        ),
        sa.Column(
            "answer_unit_price", sa.Numeric(precision=10, scale=4), nullable=False
        ),
        sa.Column(
        ...
        sa.Column(
            "agent_based", sa.Boolean(), server_default=sa.text("false"), nullable=False
        ),
    ...
    with op.batch_alter_table("messages", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "message_app_id_idx", ["app_id", "created_at"], unique=False
        )
        batch_op.create_index(
            "message_conversation_id_idx", ["conversation_id"], unique=False
        )
        batch_op.create_index(
