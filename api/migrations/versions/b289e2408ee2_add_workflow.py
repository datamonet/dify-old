...
def upgrade():
    ...
    with op.batch_alter_table("workflow_app_logs", schema=None) as batch_op:
        batch_op.create_index(
            "workflow_app_log_app_idx", ["tenant_id", "app_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "elapsed_time", sa.Float(), server_default=sa.text("0"), nullable=False
        ),
    ...
    with op.batch_alter_table("workflow_node_executions", schema=None) as batch_op:
        batch_op.create_index(
            ...
            ["tenant_id", "app_id", "workflow_id", "triggered_from", "node_id"],
            unique=False,
        )
        batch_op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "total_steps", sa.Integer(), server_default=sa.text("0"), nullable=True
        ),
        sa.Column("created_by_role", sa.String(length=255), nullable=False),
        sa.Column("created_by", postgresql.UUID(), nullable=False),
        sa.Column(
    ...
    with op.batch_alter_table("workflows", schema=None) as batch_op:
        batch_op.create_index(
            "workflow_version_idx", ["tenant_id", "app_id", "version"], unique=False
        )
