...
def upgrade():
    ...
    with op.batch_alter_table("external_knowledge_apis", schema=None) as batch_op:
        batch_op.create_index(
            "external_knowledge_apis_name_idx", ["name"], unique=False
        )
        batch_op.create_index(
            "external_knowledge_apis_tenant_idx", ["tenant_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", models.types.StringUUID(), nullable=False),
        sa.Column(
            "external_knowledge_api_id", models.types.StringUUID(), nullable=False
        ),
    ...
    with op.batch_alter_table("external_knowledge_bindings", schema=None) as batch_op:
        batch_op.create_index(
            "external_knowledge_bindings_dataset_idx", ["dataset_id"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "external_knowledge_bindings_tenant_idx", ["tenant_id"], unique=False
        )
