...
def upgrade():
    ...
    with op.batch_alter_table("app_annotation_hit_histories", schema=None) as batch_op:
        batch_op.create_index(
            "app_annotation_hit_histories_account_idx", ["account_id"], unique=False
        )
        batch_op.create_index(
        ...
        batch_op.create_index(
            "app_annotation_hit_histories_app_idx", ["app_id"], unique=False
        )
    ...
    with op.batch_alter_table("dataset_collection_bindings", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column(
                "type",
                sa.String(length=40),
                server_default=sa.text("'dataset'::character varying"),
                nullable=False,
            )
        )
    ...
    with op.batch_alter_table("message_annotations", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "conversation_id", existing_type=postgresql.UUID(), nullable=True
        )
        batch_op.alter_column(
            "message_id", existing_type=postgresql.UUID(), nullable=True
        )
...
def downgrade():
    ...
    with op.batch_alter_table("message_annotations", schema=None) as batch_op:
        batch_op.alter_column(
            "message_id", existing_type=postgresql.UUID(), nullable=False
        )
        batch_op.alter_column(
            "conversation_id", existing_type=postgresql.UUID(), nullable=False
        )
