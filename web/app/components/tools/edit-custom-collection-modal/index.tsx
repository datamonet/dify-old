...
const EditCustomCollectionModal: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { parameters_schema, schema_type } = await parseParamsSchema(
          debouncedSchema
        );
  ...
  const handleSave = () => {
    ...
    if (!postData.provider)
      errorMessage = t("common.errorMsg.fieldRequired", {
        field: t("tools.createTool.name"),
      });

    if (!postData.schema)
      errorMessage = t("common.errorMsg.fieldRequired", {
        field: t("tools.createTool.schema"),
      });
          ...
          <div className="flex flex-col h-full">
            <div className="grow h-0 overflow-y-auto px-6 py-3 space-y-4">
                  ...
                  <table className="w-full leading-[18px] text-xs text-gray-700 font-normal">
                    <thead className="text-gray-500 uppercase">
                      ...
                      >
                        ...
                        <th className="p-2 pl-3 font-medium w-[236px]">
                        ...
                        <th className="p-2 pl-3 font-medium w-[54px]">
              ...
              <div>
                ...
                <div
                  className="flex items-center h-9 justify-between px-2.5 bg-gray-100 rounded-lg cursor-pointer"
              ...
              {/* Labels */}
              <div>
                <div className="py-2 leading-5 text-sm font-medium text-gray-900">
            ...
            <div
              className={cn(
                ...
                "mt-2 shrink-0 flex py-4 px-6 rounded-b-[10px] bg-gray-50 border-t border-black/5"
              )}
            >
              {isEdit && (
                <Button
                  onClick={onRemove}
                  className="text-red-500 border-red-50 hover:border-red-500"
                >
