...
const ConfigContent: FC<Props> = ({
  ...
  const { currentModel: currentRerankModel } = useCurrentProviderAndModel(
    rerankModelList,
    rerankDefaultModel
      ? {
          ...rerankDefaultModel,
  ...
  const showWeightedScore =
    selectedDatasetsMode.allHighQuality &&
    !selectedDatasetsMode.inconsistentEmbeddingModel;

  const showWeightedScorePanel =
    showWeightedScore &&
    datasetConfigs.reranking_mode === RerankingModeEnum.WeightedScore &&
    datasetConfigs.weights;
  const selectedRerankMode =
    datasetConfigs.reranking_mode || RerankingModeEnum.RerankingModel;
  ...
  useEffect(() => {
    if (
      ...
      showRerankModel !== datasetConfigs.reranking_enable
    ) {
      onChange({
        ...datasetConfigs,
              ...
              {rerankingModeOptions.map((option) => (
                <div
                  ...
                  className={cn(
                    ...
                    selectedRerankMode === option.value &&
                      "border-[1.5px] border-components-option-card-option-selected-border bg-components-option-card-option-selected-bg text-text-primary"
                  )}
                ...
                >
                  ...
                  <Tooltip
                    popupContent={
                      <div className="w-[200px]">{option.tips}</div>
                    }
          ...
          {!showWeightedScorePanel && (
            <div className="mt-2">
              <div className="flex items-center">
                ...
                <div className="leading-[32px] text-text-secondary system-sm-semibold">
