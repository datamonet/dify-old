  ...
  const init = useCallback(async () => {
    try {
      ...
      setAllMethodsAreDisabled(
        !allFeatures.enable_social_oauth_login &&
          !allFeatures.enable_email_code_login &&
          !allFeatures.enable_email_password_login &&
          !allFeatures.sso_enforced_for_signin
      );
      setShowORLine(
        (allFeatures.enable_social_oauth_login ||
          allFeatures.sso_enforced_for_signin) &&
      ...
      updateAuthType(
        allFeatures.enable_email_password_login ? "password" : "code"
      );
      if (isInviteLink) {
    ...
    <>
      <div className="w-full mx-auto mt-8">
        ...
        <div className="bg-white">
          ...
          {showORLine && (
            <div className="relative mt-6">
              ...
              <div className="relative flex justify-center">
                <span className="px-2 text-text-tertiary system-xs-medium-uppercase bg-white">
                  {t("login.or")}
                </span>
              </div>
            </div>
          ...
          {allMethodsAreDisabled && (
            <>
              <div className="p-4 rounded-lg bg-gradient-to-r from-workflow-workflow-progress-bg-1 to-workflow-workflow-progress-bg-2">
                ...
                <p className="system-xs-regular text-text-tertiary mt-1">
          ...
          {IS_CE_EDITION && (
            <div className="w-hull block mt-2 system-xs-regular text-text-tertiary">
              {t("login.goToInit")}
              &nbsp;
              <Link
                className="system-xs-medium text-text-secondary hover:underline"
